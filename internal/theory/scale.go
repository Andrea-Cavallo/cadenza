...
var scaleIntervals = map[string][]int{
	...
	"dorian":         {0, 2, 3, 5, 7, 9, 10}, // raised 6th: dark but groovy
	"phrygian":       {0, 1, 3, 5, 7, 8, 10}, // flat 2nd: tense, dark
	"mixolydian":     {0, 2, 4, 5, 7, 9, 10}, // flat 7th: optimistic, festival
	"lydian":         {0, 2, 4, 6, 7, 9, 11}, // raised 4th: ethereal, floating
}
